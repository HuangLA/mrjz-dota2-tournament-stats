...
const ACHIEVEMENT_INFO = {
    ...
    triple_double: { name: '三双', icon: '📊', description: '完成三双' },
    godlike: { name: '超神', icon: '⚡', description: '完成超神杀戮' },
    carry_game: { name: '对不起，这把我要赢', icon: '💪', description: '在获胜的比赛中击杀数超过全队一半' },
    perfect_game: { name: '完美演出', icon: '✨', description: '在获胜的比赛中0死亡' },
